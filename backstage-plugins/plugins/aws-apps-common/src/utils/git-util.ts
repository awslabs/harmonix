  ...
  switch (gitProvider) {
    case GitProviders.GITLAB:
      return {
        ...
        gitProjectGroup: entity.metadata.annotations
          ? entity.metadata.annotations['gitlab.com/project-slug']?.toString().split('/')[0]
          : '',
        isPrivate: true,
      };
    case GitProviders.GITHUB:
      return {
        gitHost: 'github.com',
        gitRepoName: entity.metadata.annotations
          ? entity.metadata.annotations['github.com/project-slug']?.toString().split('/')[1]
          : '',
        gitOrganization: entity.metadata.annotations
          ? entity.metadata.annotations['github.com/project-slug']?.toString().split('/')[0]
          : '',
        gitProvider,
        isPrivate: true,
      };
