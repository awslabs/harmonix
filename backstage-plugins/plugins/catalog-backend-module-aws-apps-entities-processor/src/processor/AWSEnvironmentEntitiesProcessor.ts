...
import { AWSEnvironmentEntityV1, awsEnvironmentEntityV1Validator } from '@aws/plugin-aws-apps-common-for-backstage';
...
export class AWSEnvironmentEntitiesProcessor implements CatalogProcessor {
  ...
  async postProcessEntity(entity: Entity, _location: LocationSpec, emit: CatalogProcessorEmit): Promise<Entity> {
    ...
    if (entity.apiVersion === 'aws.backstage.io/v1alpha' && entity.kind === 'AWSEnvironment') {
