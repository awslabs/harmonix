...
echo "Getting kubectl version v1.32.3 from https://dl.k8s.io/release/v1.32.3/bin/linux/amd64/kubectl"
curl -LO "https://dl.k8s.io/release/v1.32.3/bin/linux/amd64/kubectl"
echo "Got kubectl. Getting kubectl sha hash."
curl -LO "https://dl.k8s.io/release/v1.32.3/bin/linux/amd64/kubectl.sha256"
