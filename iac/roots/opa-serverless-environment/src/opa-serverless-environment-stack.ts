...
import { DynamoDBConstruct, NetworkConstruct, OPAEnvironmentParams } from "@aws-app-development/common-constructs";
...
export class OPAServerlessEnvStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: OPAServerlessEnvStackProps) {
    ...
    const provisioningRoleConstruct = new ServerlessAPIProvisioningConstruct(
      this,
    ...
    const operationsRoleConstruct = new ServerlessAPIOperationsConstruct(
      this,
